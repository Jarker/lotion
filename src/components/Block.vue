  ...
  <div class="group flex w-full rounded"
    ...
    <div class="h-full pl-4 pr-2 text-center cursor-pointer transition-all duration-150 text-neutral-300 flex"
      ...
      <Tooltip value="<span class='text-neutral-400'><span class='text-white'>Click</span> to delete block</span>">
        <svg @click="emit('deleteBlock')" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="size-6 text-zinc-800 dark:text-zinc-200 hover:bg-neutral-100 dark:hover:bg-zinc-600 dark:hover:text-zinc-200 p-1 rounded group-hover:opacity-100 opacity-0 duration-200"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/><line x1="10" x2="10" y1="11" y2="17"/><line x1="14" x2="14" y1="11" y2="17"/></svg>
      </Tooltip>
      <Tooltip value="<span class='text-neutral-400'><span class='text-white'>Click</span> to add block below</span>">
        <svg @click="emit('newBlock')" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="size-6 text-zinc-800 dark:text-zinc-200 hover:bg-neutral-100 dark:hover:bg-zinc-600 dark:hover:text-zinc-200 p-1 rounded group-hover:opacity-100 opacity-0 duration-200"><path d="M5 12h14"/><path d="M12 5v14"/></svg>
      </Tooltip>
      <BlockMenu ref="menu"
